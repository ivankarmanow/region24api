...
from app.api import admin, admin_auth, client, contact, history, order, project, request, service, service_category, \
    project_category, auth
...
project.include_router(project_category)
app.include_router(project)
app.include_router(request)
service.include_router(service_category)
